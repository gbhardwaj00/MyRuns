...
@TypeConverters(LatLngListTypeConverter::class)
abstract class ExerciseEntryDatabase : RoomDatabase() {
    abstract val exerciseEntryDatabaseDAO: ExerciseEntryDatabaseDAO
        ...
        companion object{
            ...
            fun getInstance(context: android.content.Context) : ExerciseEntryDatabase{
                synchronized(this){
                    var instance = INSTANCE
                    if(instance == null){
                        instance = Room.databaseBuilder(context.applicationContext,
                            ExerciseEntryDatabase::class.java, "exercise_table").fallbackToDestructiveMigration().build()
                        INSTANCE = instance
                    }
                    return instance
                }
